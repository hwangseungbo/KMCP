                        ...
                        if(readMessage!=null){
                            ...
                            if(m[0].equals("$KMCP_HEART")) {
                                ...
                                try {
                                    ...
                                    if((n[0].length() - 1) == len) {    // $KMCP_ENGINE,RPM,Fuel Level,Coolant Temp,Oil Pressure,Oil Temp,Running Time 까지가 n[0]이므로 $자릿수를 빼주기 위해 n[0].length()에서 -1을 해준다.
                                        mm = m[6].split("\\*");
                                        ...
                                        tv_CoolantTempValue.setText(m[4] + "ºF");
